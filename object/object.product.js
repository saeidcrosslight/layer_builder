        ...
        .factory('product', ['$rootScope', 'filetree', 'message', 'editor', 'file', 'childprocess', '$sce', function ($rootScope, filetrees, messages, editor, file, childprocess, $sce) {
                var factory = {},
                        ...
                        init = function () {
                            ...
                            this.navigations = getNavigation(this.productName);
                            this.quickMenus = getQuickBar(this.productName);
                        ...
                        getNavigation = function (productName) {
                            return angular.fromJson(file.readallsync("json\\nav\\navigation_" + productName + ".json"));
                        },
                        getQuickBar = function (productName) {
                            if (productName === "CSuprem")
                                return angular.fromJson(file.readallsync("json\\quick\\quick_Csuprem.json"));
                            else
                                return angular.fromJson(file.readallsync("json\\quick\\quick_Apsys.json"));
                        },
